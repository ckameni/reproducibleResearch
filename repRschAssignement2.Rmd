...
MergedDf$EVTYPE<-gsub("flood/flash","flash flood",MergedDf$EVTYPE)
MergedDf$EVTYPE<-gsub("flash flooding/flood","flash flood",MergedDf$EVTYPE)
MergedDf$EVTYPE<-gsub("flash floodflood","flash flood",MergedDf$EVTYPE)
...
MergedDf$EVTYPE<-gsub("coastal flooding/erosion","coastal flood/erosion",MergedDf$EVTYPE)
MergedDf$EVTYPE<-gsub("coastal flood/erosion" ,"coastal flood/erosion",MergedDf$EVTYPE)
MergedDf$EVTYPE<-gsub("coastal  flooding/erosion","coastal flood/erosion",MergedDf$EVTYPE)
...
dim(damageDf)
# Sorted by Total Fatalities
arrange(health_by_evtype,desc(TotalFatalities)) %>% head(10)
